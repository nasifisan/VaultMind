...
VaultMind/                      ← single repo
├── src/
│   ├── VaultMind.API/          # C# .NET backend
│   ├── VaultMind.Engine/       # C++ inference engine
│   └── vaultmind-dashboard/    # React frontend
├── infra/
│   ├── docker-compose.yml      # one command runs everything
│   └── Dockerfiles
├── docs/
├── README.md                   # one README tells the full story
└── .gitignore
